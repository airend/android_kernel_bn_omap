...
static struct twl4030_resconfig bn_twl_resconfig[] = {
	{
...
static struct twl4030_power_data bn_twl_power_data = {
	.resource_config = bn_twl_resconfig,
};
#endif

static struct twl4030_platform_data twldata = {
#ifdef CONFIG_TWL6030_POWER
	.power		= &bn_twl_power_data,
#endif
